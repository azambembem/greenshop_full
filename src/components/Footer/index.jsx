...
// // // const Footer = () => {
// // //   const [suscribeMode, setSubscribeMode] = useState({ isLoading: false, isS });
...
// //         </div>
// //       </div>
// //       <p className="font-light p-[23px] border-t text-sm">
// //         © 2023 GreenShop. All Rights Reserved.
// //       </p>
// //     </div>
// //   );
...
//             <div className="flex w-full h-[40px] mb-[17px]">
//               <input
//                 disabled={subscribeMode.isSubscribed}
//                 className="h-full w-4/5 rounded-s-xl pl-[11px] placeholder:font-light"
//                 placeholder="enter your email address..."
//                 ref={emailRef}
//                 onKeyDown={(e) =>
...
//                 className="h-full w-1/5 rounded-none rounded-e-xl"
//               >
//                 {subscribeMode.isSubscribed ? (
//                   subscribeMode.isLoading ? (
//                     <LoadingOutlined />
//                   ) : (
//                     <CheckOutlined />
//                   )
...
//             </div>
//             <p className="font-light text-xs leading-6">
//               We usually post offers and challenges in the newsletter. We’re
//               your online houseplant destination, offering a wide range of
//               houseplants and accessories shipped directly from our (green)house
//               to yours!
//             </p>
//           </div>
